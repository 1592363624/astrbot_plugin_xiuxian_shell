...
revision: str = "v009"
down_revision: str | Sequence[str] | None = "v008"
...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column(
            ...
            sa.Text,
            nullable=False,
            comment="闭关结果: success/failure/possession",
        ),
        sa.Column(
            "exp_change",
            sa.Integer,
            nullable=False,
            server_default="0",
            comment="修为变化(正数增加,负数减少)",
        ),
        sa.Column(
            "encounter_event_id", sa.Text, nullable=True, comment="触发的奇遇事件ID"
        ),
        sa.Column(
            "cooldown_minutes",
            sa.Integer,
        ...
        sa.Column(
            "cooldown_until", sa.TIMESTAMP, nullable=True, comment="冷却结束时间"
        ),
        sa.Column(
            "created_at",
            sa.TIMESTAMP,
    ...
    op.create_table(
        ...
        sa.Column(
            "expires_at", sa.TIMESTAMP, nullable=False, comment="丹毒消解时间(24小时后)"
        ),
        sa.Column(
            "created_at",
            sa.TIMESTAMP,
