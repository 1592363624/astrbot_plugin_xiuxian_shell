...
revision: str = "v008"
down_revision: Union[str, Sequence[str], None] = "v007"
...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column("template_variables", sa.Text, nullable=True, comment="模板变量(JSON)"),
        sa.Column("cron_expression", sa.Text, nullable=False, comment="Cron表达式(分 时 日 月 周)"),
