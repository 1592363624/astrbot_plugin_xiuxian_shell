...
def calculate_level(experience: int, base_exp: int = 100, multiplier: float = 1.5) -> int:
    """
    根据经验值计算等级
...
def calculate_exp_for_level(target_level: int, base_exp: int = 100, multiplier: float = 1.5) -> int:
    """
    计算达到目标等级所需的经验值
