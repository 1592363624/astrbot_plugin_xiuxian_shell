...
class EventService:
    ...
    async def get_event_by_id(self, event_id: str) -> Optional[GameEvent]:
        """根据ID获取事件"""
    ...
    async def update_event(self, event_id: str, **kwargs) -> Optional[GameEvent]:
        """更新事件"""
        allowed_fields = ["name", "description", "event_type", "trigger_condition", "reward_type", "reward_value", "probability", "is_active"]
        updates = []
        values = []
